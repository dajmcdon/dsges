...
library(batchtools)
setwd('~/Documents/DSGEs_Update/')
makeRegistry('SWpermutations2019', 
             seed = 20190921,
             packages=c('QZ','FKF','optimr'), 
             source = c('code/functions/SimsCodesFort.R', 'code/functions/modelsol.R',
                        'code/functions/reparlogp.R', 'code/priorsetup.R','code/dataload.R'))
...
submitJobs(ids, resources=list(nodes=1, ppn=1, walltime='48:00:00', memory='8gb'))
