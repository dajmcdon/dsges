...
Science Foundation Grants DMS-1407439 and DMS-1753171. We are grateful
for advice and comments to David N. DeJong, J. Bradford DeLong and
Robert Waldmann (none of whom should be held responsible for our
choices). CRS wishes to acknowledge support from the National Science
...
model is 875 compared to 948 for the SW model. The MSEs are 0.26
compared to 0.524 respectively.
...
behalf of DSGEs through series permutation, and through simply checking
how well a DSGE can be estimated from its own simulation output. In both
cases, the results are rather negative.
