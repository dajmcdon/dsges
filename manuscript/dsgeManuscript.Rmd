...
equilibria with each other.  The model we focus on, that of
\citet{SmetsWouters2007}, while now some years old, is still widely regarded as
an acceptable baseline model.  A great deal of macroeconomic theorizing thus
consists of taking this model, or other very similar ones, and elaborating on
them by adding new frictions or shocks.
...
\section{Permuting the data} {#sec:permutation-summary}
